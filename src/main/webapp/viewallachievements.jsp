    ...
    <div class="container">
        ...
        <div class="table-container">
            <table>
                ...
                <c:forEach items="${achievements}" var="stdach">
                    <tr>
                        <td><c:out value="${stdach.achievementName}"/></td>
                        <td><c:out value="${stdach.achievementDescription}"/></td>
                        <td><c:out value="${stdach.dateAchieved}"/></td>
                    </tr>
                </c:forEach>
            </table>
        </div>
