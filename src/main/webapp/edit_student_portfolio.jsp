...
<html>
<head>
    <title>Edit Student Portfolio</title>
...
<body>
    ...
    <div class="content-wrapper">
        <div class="page-header">
            ...
            <p>Update your professional portfolio information</p>
        </div>

        <div class="form-container">
            <form action="${pageContext.request.contextPath}/update-student-portfolio" method="post" enctype="multipart/form-data" class="form-grid">
                ...
                <div class="form-section">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="studentName" name="studentName" value="${portfolio.studentName}" required/>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="tel" id="phoneNumber" name="phoneNumber" value="${portfolio.phoneNumber}" required/>
                    </div>
                </div>
                ...
                <div class="form-section">
                    ...
                    <div class="form-group">
                        ...
                        <input type="url" id="profileImageUrl" name="profileImageUrl" value="${portfolio.profileImageUrl}"/>
                    </div>
                </div>
                ...
                <div class="form-section full-width">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="projectDetails" name="projectDetails">${portfolio.projectDetails}</textarea>
                    </div>
                </div>
                ...
                <div class="form-section">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="achievements" name="achievements">${portfolio.achievements}</textarea>
                    </div>
                </div>
                ...
                <div class="form-section full-width">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="socialLinks" name="socialLinks">${portfolio.socialLinks}</textarea>
                    </div>
                </div>
